...
if (inputData.plot2DFlowfield || inputData.plot3DFlowfield)
    ...
    if inputData.plot3DFlowfield
        [flowField.X,flowField.Y,flowField.Z] = meshgrid(...
            -200 : inputData.flowField.resx : flowField.dims(1)+500,...
            -200 : inputData.flowField.resy : flowField.dims(2)+200,...
            0    : inputData.flowField.resz : 200);
    else
        [flowField.X,flowField.Y,flowField.Z] = meshgrid(...
            -200 : inputData.flowField.resx : flowField.dims(1)+1000,...
            -200 : inputData.flowField.resy : flowField.dims(2)+200,...
