classdef zoned_velocity < velocity_interface
    ...
    methods
        ...
        function Vdeficit = deficit(obj, x, y, z)
            ...
            cFull = @(x,r) ((abs(r)<=rZones(x,3))-(abs(r)<rZones(x,2))).*cZones(x,3)+...
