function [xopt,P_bl,P_opt] = optimizeControlSettingsSimpleGS(florisRunner, ~, yawOpt, ~, pitchOpt, ~, axialOpt,optVerbose)
...
if nargin <= 7
    [xopt,P_bl,P_opt] = optimizeControlSettingsRobustGS(florisRunner, ' ', ...
        yawOpt, ' ', pitchOpt, ' ', axialOpt, 5*pi/180, 1);
else
    [xopt,P_bl,P_opt] = optimizeControlSettingsRobustGS(florisRunner, ' ', ...
        yawOpt, ' ', pitchOpt, ' ', axialOpt, 5*pi/180, 1, optVerbose);
end
end
