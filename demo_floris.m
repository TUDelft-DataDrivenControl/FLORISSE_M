...
FLORIS_sim.visualize(1,1,1); % Generate a layout plot, a 2D visualization and a 3D visualization
disp(' '); disp(' ');
...
FLORIS_optAx.visualize(0,1,0);                  % Generate a 2D visualization
disp(' '); disp(' ');
...
FLORIS_opt.visualize(0,1,0);                  % Generate a 2D visualization